...
spark = SparkSession.builder \
    ...
    .config("spark.sql.shuffle.partitions", "2")  # Configuración para optimizar el número de particiones
...
kafka_streaming_df = spark \
    ...
    .option("startingOffsets", "earliest")  # Asegurarse de leer desde el inicio
    .load()

# Los datos de Kafka son binarios, así que los convertimos en texto
kafka_streaming_df = kafka_streaming_df.selectExpr("CAST(key AS STRING)", "CAST(value AS STRING)")
